(function() {
    ...
    a = {
        ...
        Events: {
            ...
            onMouseUp: function() {
                if (!a.widget_open && a.dragging_x) {
                    ...
                    60 < a.left || a.scroll_container_width + 60 < a.window_width ? (a.widget_scroll_container.css("transition", "left 0.2s ease-in"), a.widget_scroll_container.css("left", 60), a.left = 60, c()) : a.left < b && (a.widget_scroll_container.css("transition", "left 0.2s ease-in"), a.widget_scroll_container.css("left", b), a.left = b, c())
                }
            },
        ...
        openWidgetA: function(b) {
            var c = b.data("name"),
            d = b.data("link");
            color = b.data("color");
            var e = color && "" !== color ?  color:b.css("background-color");
        ...
        _loadWidget: function(b, c) {
            ...
            m = function(b){
            	  a.widget_preview.css("background-image", "none");
                var c = $("#widget_preview_content");
                c.length ? c.html('<iframe style="HEIGHT: 100%; WIDTH: 100%;" frameborder=0 scrolling=auto src="'+$.trim(b.data("url"))+'" ></iframe>') : c = $("<div>").attr("id", "widget_preview_content").insertAfter(a.widget_sidebar).html('<iframe style="HEIGHT: 100%; WIDTH: 100%;" frameborder=0 scrolling=auto src="'+ $.trim(b.data("url"))+'" ></iframe>');
                "true" !== j.getItem("melonhtml5_metro_ui_sidebar_first_time") && (a.widget_sidebar.addClass("open"), a.widget_sidebar.mouseenter(function() {
                    j.setItem("melonhtml5_metro_ui_sidebar_first_time", "true", Infinity);
                    $(this).removeClass("open")
                }))
