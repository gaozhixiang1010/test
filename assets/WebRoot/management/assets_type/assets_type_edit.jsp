...
<form id="return_plan" method="post" action="<%=path %>/assets_type/updateAsstesType.action" onsubmit="return validateCallback(this, return_back);">
<div class="pageFormContent" layoutH="0" >
	<div class="searchBar" style="height: 90px;">
		<ul class="opendialog">
		<input name="type_id" type="hidden" value="${assetsTypeBean.type_id }" />
		<li><label>资产名称:</label>
		<input name="type_name" type="text" size="30" value="${assetsTypeBean.type_name }" class="form-control"  check-type="required"/>
		</li>
		</ul>
	</div>
	<div class="formBar">
