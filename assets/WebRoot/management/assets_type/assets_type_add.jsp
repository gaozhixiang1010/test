...
<form id="return_plan" method="post" action="<%=path %>/assets_type/addAsstesType.action" onsubmit="return validateCallback(this, return_back);">
<div class="pageFormContent" layoutH="0" >
	<div class="searchBar" style="height: 90px;">
		<ul class="opendialog">
		<li><label>类型名称:</label>	   
		<input name="type_name" type="text" size="30" id="text" value="" class="form-control"  check-type="required" />
		</li>
		</ul>
	</div>
	<div class="formBar">
